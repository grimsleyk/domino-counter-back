...
public class MainActivity extends AppCompatActivity
{
    ...
    {
        // Updates the subtotal value with the selected left or right domino
    ...
    private void initiateButtons()
    {
        ...
        ImageButton dominoZero = (ImageButton) findViewById(R.id.domino_zero);
        ...
        ImageButton dominoOne = (ImageButton) findViewById(R.id.domino_one);
        ...
        ImageButton dominoTwo = (ImageButton) findViewById(R.id.domino_two);
        ...
        ImageButton dominoThree = (ImageButton) findViewById(R.id.domino_three);
        ...
        ImageButton dominoFour = (ImageButton) findViewById(R.id.domino_four);
        ...
        ImageButton dominoFive = (ImageButton) findViewById(R.id.domino_five);
        ...
        ImageButton dominoSix = (ImageButton) findViewById(R.id.domino_six);
        ...
        ImageButton dominoSeven = (ImageButton) findViewById(R.id.domino_seven);
        ...
        ImageButton dominoEight = (ImageButton) findViewById(R.id.domino_eight);
        ...
        ImageButton dominoNine = (ImageButton) findViewById(R.id.domino_nine);
        ...
        ImageButton dominoTen = (ImageButton) findViewById(R.id.domino_ten);
        ...
        ImageButton dominoEleven = (ImageButton) findViewById(R.id.domino_eleven);
        ...
        ImageButton dominoTwelve = (ImageButton) findViewById(R.id.domino_twelve);
